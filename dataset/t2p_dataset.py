...
class T2PDataset(Dataset):
    def __init__(self, dataset, mode=0, device='cuda', transform=None, input_time=None):
        ...
        if dataset == "mocap_umpm":
            ...
            if mode==0: # Train
                if input_time == 50: 
                    self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/mocap_UMPM/train/*.pt')
                elif input_time == 25:
                    self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/mocap_UMPM_input25_v2/train/*.pt')
            else:   # Val, Test
                if input_time == 50:
                    self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/mocap_UMPM/val/*.pt')
                elif input_time == 25:
                    self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/mocap_UMPM_input25_v2/val/*.pt')
        elif dataset == "3dpw":
            self.num_person = 2
            if input_time != 10: raise Exception('Input time step other than 10 is not implemented yet')
            if mode==0:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/3dpw_input10_v2/train/*.pt')
            elif mode==1:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/3dpw_input10_v2/val/*.pt')
            ...
            if mode==0:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_input15_maxPerson20/train/*.pt')
            elif mode==1:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_input15_maxPerson20/val/*.pt')              
        elif dataset == "jrdb_1_2_25":
            self.num_person = 25    # Max num person
            if mode==0:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v2_input_1_output_2_frameRep_1_v2/train/*.pt')
            elif mode==1:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v2_input_1_output_2_frameRep_1_v2/val/*.pt')              
        elif dataset == "jrdb_1_2_25_15":
            self.num_person = 25    # Max num person
            if mode==0:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v2_input_1_output_2_frameRep_15_v3/train/*.pt')
            elif mode==1:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v2_input_1_output_2_frameRep_15_v3/val/*.pt')
        elif dataset == "jrdb_2_4_25":
            self.num_person = 25    # Max num person
            if mode==0:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v2_input_2_output_4_frameRep_1_v2/train/*.pt')
            elif mode==1:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v2_input_2_output_4_frameRep_1_v2/val/*.pt')
        elif dataset == "jrdb_2_5_25":
            self.num_person = 25    # Max num person
            if mode==0:
                # self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v2_input_2_output_5_frameRep_3_test/train/*.pt')
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v3_input_2_output_5_frameRep_3/train/*.pt')
            elif mode==1:
                # self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v2_input_2_output_5_frameRep_3_test/val/*.pt')
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v3_input_2_output_5_frameRep_3/val/*.pt')
        elif dataset == "jrdb_3_6_25":
            self.num_person = 25    # Max num person
            if mode==0:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v2_input_3_output_6_frameRep_1_v2/train/*.pt')
            elif mode==1:
                self.data = glob.glob('/ssd4tb/t2p/t2p/preprocessed/jrdb_bev_v2_input_3_output_6_frameRep_1_v2/val/*.pt')
